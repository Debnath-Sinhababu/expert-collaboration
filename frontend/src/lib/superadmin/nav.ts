...
export const superAdminNavItems: SuperAdminNavItem[] = [
  ...
  { href: '/superadmin/projects', label: 'Projects', permission: 'requirements:read', icon: FolderKanban },
  { href: '/superadmin/margin-review', label: 'Margin Review', permission: 'requirements:read', icon: Percent },
